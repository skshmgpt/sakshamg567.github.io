    ...
    <main className="container-grid relative z-10">
      ...
      <div className="flex flex-col gap-6 px-12 py-10">
        <p className="font-mono text-[14px] text-[#F0F0EB] leading-relaxed">
          ...
          institute of technology. i&apos;m deeply interested in how systems
          work under the hood — databases, networks, operating systems, and
          distributed consensus. i spend most of my time building backend
        ...
        <p className="font-mono text-[14px] text-[#889988] leading-relaxed">
          ...
          freestand, building fintech infrastructure — payment systems,
          developer dashboards, and internal tooling. i work across the stack
          with typescript, next.js, and go microservices.
        </p>

        <p className="font-mono text-[14px] text-[#889988] leading-relaxed">
          when i&apos;m not coding, you&apos;ll find me reading papers on
          distributed systems, wrestling with my neovim config, lifting at the
          gym, or cooking something new in the kitchen. i believe in building
      ...
      <div className="flex flex-col gap-5 px-12 py-10">
        ...
        <p className="font-mono text-[13px] text-[#889988] leading-relaxed">
          ...
          mono. deployed on vercel. the noise texture is a custom canvas
          implementation. keyboard navigation via vim bindings.
        </p>
      </div>
    </main>
  );
