...
const App = () => {
  ...
  return (
    <main
      className={`flex min-h-screen flex-col text-white px-8 md:px-16 lg:px-24 my-8 max-w-5xl mx-auto z-100 relative`}
    >
      <div className="mt-10 md:mt-0 mb-10 flex sm:flex-row items-center gap-5 rounded-md justify-between font-mono">
      ...
      <section className="mt-12 font-mono">
      ...
      <section id="Blogs" className="mt-12 font-mono">
